...
var muteli = "774866209710538773"; //buraya muteli rolünün id'sini koyunuz
var muteyetkisi = "774866224348790814"; // buraya mute yetkis irolünün id yazınız.
      ...
      if (
        ...
        if (!mutezaman) {
          ...
          let log = msg.guild.channels.find(c =>
            c.id.toLowerCase().includes("781815770560724992") //  
          );
          let vakit = mutezaman
            .replace("m", " dakika")
            .replace("s", " saniye")
